...
## 🔑 Credentials (Valid as of 2026-02-28 — BARPEL AI Project)
...
# Authentication
ACCESS_TOKEN="sbp_3d4d74379e0a50361ccf1a7c94e54a8985e281ab"
...
DB_URL="postgresql://postgres:Eguale%402021%3F@db.wifcmvgwzicgyrvaoiwi.supabase.co:5432/postgres"

# MCP Server
MCP_URL="https://mcp.supabase.com/mcp?project_ref=wifcmvgwzicgyrvaoiwi"
```

**Note:** These credentials are for the BARPEL AI project (wifcmvgwzicgyrvaoiwi). Always check `backend/.env` for the latest values.
...
```bash
curl -X POST "https://api.supabase.com/v1/projects/wifcmvgwzicgyrvaoiwi/database/query" \
  -H "Authorization: Bearer sbp_3d4d74379e0a50361ccf1a7c94e54a8985e281ab" \
  -H "Content-Type: application/json" \
...
## 🎯 Real-World Example (2026-02-02 Fix)
...
**Last Updated:** 2026-02-28 (Updated for BARPEL AI Project)
**Project:** wifcmvgwzicgyrvaoiwi (BARPEL AI)
**Previous Project:** lbjymlodxprzqgtyqtcq (Voxanne AI - Legacy)
**Tested By:** Claude Sonnet 4.5 + Claude Sonnet 4.6
