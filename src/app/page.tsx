...
export const metadata: Metadata = {
  title: "Barpel AI | The #1 AI Receptionist for Clinics & Spas",
  description: "Barpel is the AI voice receptionist that answers, qualifies, and books appointments 24/7 for clinics and med spas. HIPAA-compliant. No missed calls.",
