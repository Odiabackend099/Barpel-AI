...
export const metadata: Metadata = {
  title: "Case Studies - Barpel AI",
  description: "Real results from clinics using Barpel AI. See how AI receptionists increase bookings, reduce no-shows, and save staff time.",
};
...
const caseStudies = [
  {
    ...
    solution: "Deployed Barpel AI to handle all after-hours calls and overflow during busy periods. Integrated with their existing calendar system.",
    results: [
    ...
    quote: "Barpel AI answered the calls we were missing. In the first month, we booked 47 additional consultations that would have gone to voicemail. The ROI was immediate.",
  ...
  },
  {
    ...
    solution: "Implemented Barpel AI for 24/7 availability, with custom scripts for cosmetic procedures and pricing discussions.",
    results: [
    ...
    quote: "In cosmetic surgery, timing is everything. Patients shop around. Being the first to respond means we win the consultation. Barpel AI gave us 24/7 responsiveness without hiring night staff.",
  ...
  },
  {
    ...
    solution: "Trained Barpel AI on their knowledge base covering common procedures, insurance plans, and appointment policies.",
    results: [
      ...
      <main className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            See how medical practices are using Barpel AI to increase bookings, reduce no-shows, and save staff time.
          </p>
        </div>
        ...
        <div className="mt-20 bg-gradient-to-br from-surgical-50 to-white border border-slate-200 rounded-3xl p-8 md:p-12 text-center">
          ...
          <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
            Schedule a demo to see how Barpel AI can transform your practice's patient communication.
          </p>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-slate-600">Clinics using Barpel AI</p>
          </div>
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
