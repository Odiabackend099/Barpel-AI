...
export const metadata: Metadata = {
  title: "Get Started with Barpel AI | Free Trial - No Credit Card",
  ...
  keywords: ["get started", "barpel signup", "ai receptionist trial", "free demo"],
  openGraph: {
    title: "Get Started with Barpel AI | Free Trial",
