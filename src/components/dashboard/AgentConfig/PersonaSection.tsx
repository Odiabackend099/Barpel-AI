  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-surgical-200 p-6 mb-8">
      <div className="flex items-center justify-between mb-1">
        ...
        <span className="text-xs text-barpel-slate/40 font-medium">Choose your agent&apos;s personality</span>
      </div>
      <p className="text-xs text-barpel-slate/50 mb-4">
          ...
          return (
            <button
              ...
              className={`text-left p-4 rounded-xl border-2 transition-all group relative ${
                isSelected
                  ? 'border-barpel-teal bg-surgical-50 shadow-sm'
                  : 'border-surgical-200 hover:border-surgical-400 hover:bg-surgical-50/50'
              }`}
            >
              {isSelected && (
                <span className="absolute top-2.5 right-2.5 w-5 h-5 rounded-full bg-barpel-teal flex items-center justify-center">
              ...
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <div>
                  <div className="font-semibold text-barpel-slate text-sm leading-tight">{template.name}</div>
