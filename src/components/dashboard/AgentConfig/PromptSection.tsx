    ...
    <>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-surgical-200 p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-surgical-50 text-barpel-slate/60 font-medium">
            Core Personality
          </span>
        </div>
        ...
        <textarea
          ...
          className="w-full h-64 min-h-[8rem] px-4 py-3 rounded-xl bg-surgical-50 border border-surgical-200 text-barpel-slate focus:ring-2 focus:ring-surgical-500 outline-none resize-y font-mono text-sm leading-relaxed"
        />
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-surgical-200 p-6">
        ...
        <textarea
          ...
          className="w-full h-24 px-4 py-3 rounded-xl bg-surgical-50 border border-surgical-200 text-barpel-slate focus:ring-2 focus:ring-surgical-500 outline-none resize-none"
        />
      </div>
    </>
  );
