...
export async function sendDemoEmailTemplate(
  ...
  const subject = `Your ${demo_type === 'outbound_intro' ? 'Outbound' : 'Inbound'} Call Waiting AI Demo - ${clinic_name}`;
...
<body>
    <div class="container">
        <div class="header">
            <h1>Your Call Waiting AI AI Demo</h1>
            <p>The #1 AI Receptionist for ${clinic_name}</p>
        </div>
        <div class="content">
            <p>Hi ${to_name},</p>

            <p>Thanks for your interest in Call Waiting AI! We've prepared a personalized demo showing exactly how our AI receptionist can transform ${clinic_name}'s phone operations.</p>
  ...
  const textBody = `
Your Call Waiting AI AI Demo

Hi ${to_name},

Thanks for your interest in Call Waiting AI! We've prepared a personalized demo showing exactly how our AI receptionist can transform ${clinic_name}'s phone operations.
