...
<head>
  ...
  <title>Stress Test Report - Barpel AI</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  <div class="container">
    <div class="header">
      ...
      <p>Barpel AI - Multi-Agent Orchestration Validation</p>
...
export function generateMarkdownReport(report: StressTestReport): string {
  ...
  const markdown = `# 🧪 Stress Test Report - Barpel AI
...
**Report ID:** ${generateReportId()}  
**Generated by:** Barpel AI Test Framework v1.0
`;
